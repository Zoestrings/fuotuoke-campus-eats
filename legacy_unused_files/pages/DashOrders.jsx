...
export default function DashOrders({ isStaff, accent, orders, setPage, onTrackOrder }) {
    ...
    <div className="page-bg">
      <div className="orders-page-root">
        ...
        <h2 className="page-heading">
          <i className={`bi bi-receipt`} style={{ color: isGold ? "var(--gold)" : "var(--primary)" }} />
          My Orders
        </h2>
              ...
              return (
                <div key={order.id} className="order-list-item">
                  ...
                  <div className="order-list-footer">
                    ...
                    {status !== "Completed" && (
                      <Btn sm variant={isGold ? "gold" : "primary"} onClick={() => onTrackOrder(order)}>
