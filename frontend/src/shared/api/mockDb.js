...
const SEED_MENU = [
  { id: 1, name: "Eba + soup (Egusi/Vegetable)", price: 1500.00, cat: "Soup", image: "/images/menu/eba_egusi_soup.jpg", desc: "Fresh garri served with choice of Egusi or Vegetable soup", popular: 1, available: 1 },
  { id: 2, name: "Eba + Okra soup", price: 1500.00, cat: "Soup", image: "/images/menu/eba_okra_soup.jpg", desc: "Yellow garri paired with draw okra soup and fish", popular: 0, available: 1 },
  { id: 3, name: "Amala + Ewedu/Gbegiri", price: 1700.00, cat: "Soup", image: "/images/menu/amala_ewedu.jpg", desc: "Soft yam flour with combination of Ewedu and bean soup", popular: 1, available: 1 },
  { id: 4, name: "Pounded yam + soup", price: 1700.00, cat: "Soup", image: "/images/menu/pounded_yam_soup.jpg", desc: "Smooth pounded yam served with choice of soup", popular: 1, available: 1 },
  { id: 5, name: "Pepper soup (fish)", price: 2500.00, cat: "Soup", image: "/images/menu/pepper_soup_fish.jpg", desc: "Spicy pepper soup broth served with fresh catfish", popular: 0, available: 1 },
  { id: 6, name: "Jollof Rice & Chicken", price: 2500.00, cat: "Rice", image: "/images/menu/jollof_rice_chicken.jpg", desc: "Rich smokey Nigerian party Jollof served with fried chicken", popular: 1, available: 1 },
  { id: 7, name: "Fried Rice & Fish", price: 2500.00, cat: "Rice", image: "/images/menu/fried_rice_chicken.jpg", desc: "Savory seasoned fried rice mixed with vegetables and fried fish", popular: 0, available: 1 },
  { id: 8, name: "White Rice & Stew", price: 1800.00, cat: "Rice", image: "/images/menu/white_rice_stew.jpg", desc: "Fluffy white long-grain rice served with standard tomato stew and beef", popular: 0, available: 1 },
  { id: 9, name: "Spaghetti Bolognese", price: 2000.00, cat: "Mains", image: "/images/menu/spaghetti_chicken.jpg", desc: "Pasta tossed in seasoned minced beef sauce", popular: 1, available: 1 },
  { id: 10, name: "Plantain & Egg Sauce", price: 1500.00, cat: "Mains", image: "/images/menu/fried_plantain.jpg", desc: "Fried sweet plantain slices served with scrambled egg sauce", popular: 0, available: 1 },
